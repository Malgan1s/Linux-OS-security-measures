...
## Содержание
- [Установка ОС](#1-установка-ос)
- [Основная часть](#2-основная-часть)
  - [Описания процесса установки дистрибутива Astra Linux](#21-описание-процесса-установки-дистрибутива-asra-linux)
  - [Изучение команды adduser](#22-изучение-команды-adduser)
  - [Изучение команд groupadd, groupmod, usermod](#23-изучение-команд-groupadd-groupmod-usermod)
  - [Изучение утилиту passwd](#24-изучение-утилиту-passwd)
  - [Устанавка mc](#25-устанавка-mc)
  - [Изучение команды history](#26-изучение-команды-history)
  - [Изучение команд grep, cat, ls (ключи, применение)](#27-изучение-команд-grep-cat-ls-ключи-применение)
  - [Изучение chmod, chown, chgrp (демонстрация применения)](#28-изучение-chmod-chown-chgrp-демонстрация-применения)
  - [Изучение утилиты ip](#29-изучение-утилиты-ip)
  - [Изучение утилиту traceroute](#210-изучение-утилиту-traceroute)
  - [Изучение утилиты iptables (блокировка возможности применения утилиты ping извне)](#211-изучение-утилиты-iptables-блокировка-возможности-применения-утилиты-ping-извне)
  - [Настраивание подключения к виртуальной машине по ssh, используя пароль](#212-настраивание-подключения-к-виртуальной-машине-по-ssh-используя-пароль)
  - [Работа с журналами Linux: изучение инструменты journalctl и logwatch](#213-работа-с-журналами-linux-изучение-инструменты-journalctl-и-logwatch)
...
## 2.1 Описание процесса установки дистрибутива Asra Linux
...
В ходе выполненной лабораторной работы была произведена установка и базовая 
настройка операционной системы Astra Linux, включая конфигурацию сетевых 
интерфейсов и обновление системы, после чего были изучены и практически 
применены ключевые средства обеспечения безопасности ОС Linux: управление 
пользователями и группами, настройка паролей, права доступа к файлам, а также 
анализ сетевых параметров и маршрутов. Дополнительно была отработана работа 
с инструментами мониторинга и аудита (history, journalctl, logwatch), настройка 
безопасного удалённого доступа по SSH с использованием ключей, а также применение
межсетевого экрана iptables. В совокупности данные действия позволили освоить основные
механизмы защиты и контроля, обеспечивающие безопасную эксплуатацию системы на базе Linux.
